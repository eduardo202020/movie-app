      ...
      <View className="">
        ...
        <View className="my-6 mx-4 space-y-2 ">
          ...
          <Text className="text-neutral-400 tracking-wide">
            ...
            minus natus, ullam corrupti, magni quis dicta rem vel omnis mollitia
            provident. Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            Voluptatem sapiente fugiat, sed reiciendis itaque placeat sit
            officia numquam cumque aspernatur ea. Animi incidunt labore deleniti
            blanditiis maxime, non similique saepe?
          </Text>
        </View>
        {/* Movies */}
